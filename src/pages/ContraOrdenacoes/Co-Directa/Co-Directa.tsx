...
const RenderSegment = (props: { segment: string, setCoDirectaData: any }) => {
    if (props.segment === 'intervenientes') {
        return (<Intervenientes setCoDirectaData={props.setCoDirectaData} active={false}/>)
    } else if (props.segment === 'dados_da_infracao') {
        return (<DadosInfracao setCoDirectaData={props.setCoDirectaData} active={false} />)
    } else if (props.segment === 'dados_complemenatares') {
        return (<DadosComplementares setCoDirectaData={props.setCoDirectaData} active={false}/>)
    }
