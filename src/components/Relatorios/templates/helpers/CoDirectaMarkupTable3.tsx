    ...
    >
        <style
            ...
            dangerouslySetInnerHTML={{
                __html:
                    "\n                    #JR_PAGE_ANCHOR_0_3 th {\n                        font-weight: normal;\n                    }\n\n                    #JR_PAGE_ANCHOR_0_3 ul {\n                        list-style-type: disc;\n                        padding-inline-start: 40px;\n                        margin: 0px;\n                    }\n\n                    #JR_PAGE_ANCHOR_0_3 ol {\n                        list-style-type: decimal;\n                        padding-inline-start: 40px;\n                        margin: 0px;\n                    }\n                "
            }}
        />
        <tbody>
        ...
        <tr style={{height: 1}}>
            <td></td>
            <td colSpan={67} style={{borderTop: "1px solid #000000"}}></td>
            <td></td>
        </tr>
        <tr style={{height: 1}}>
            <td colSpan={69}></td>
        ...
        <tr style={{height: 40}}>
            <td></td>
            <td colSpan={67} style={{textIndent: 0, textAlign: "left"}}></td>
            <td></td>
        </tr>
        <tr style={{height: 2}}>
            <td colSpan={69}></td>
                        ...
                        Testemunhas
                            ...
                            <tr style={{height: 21}}>
                                ...
                                <td colSpan={8} className={"signPlace testemunhaAssinatura1"}  style={{pointerEvents: "auto"}}>
                                    {!_.isEmpty(assinaturaTestemunha_1) ? <img src={assinaturaTestemunha_1} /> :'' }
                                </td>
                                <td colSpan={2}></td>
                            </tr>
                            <tr style={{height: 3}}>
                            ...
                            <tr style={{height: 21}}>
                                ...
                                <td colSpan={8} className={"signPlace testemunhaAssinatura2"}  style={{pointerEvents: "auto"}}>
                                    {!_.isEmpty(assinaturaTestemunha_2) ? <img src={assinaturaTestemunha_2} /> :'' }
                                </td>
                                <td></td>
                            </tr>
                            <tr style={{height: 3}}>
                        ...
                        O Arguido
                            ...
                            <tr style={{height: 21}}>
                                ...
                                <td colSpan={7} className="signPlace" style={{pointerEvents: "auto", textAlign: "center"}}>
                                    {!_.isEmpty(assinaturaArguido) ? <img src={assinaturaArguido} /> :'' }
                                </td>
                                <td colSpan={2}></td>
                            </tr>
                            <tr style={{height: 7}}>
