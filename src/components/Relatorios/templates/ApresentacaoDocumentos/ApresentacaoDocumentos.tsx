...
export const ApresentacaoDocumentos: React.FC<IProps> = (props) => {
    ...
    return (
        <table width="100%" cellPadding={0} cellSpacing={0}>
            ...
            <tr>
                ...
                <td align="center">
                    <table
                        id="JR_PAGE_ANCHOR_APRESE_DOCS_0_1"
                        role="none"
                        className="jrPage"
                        data-jr-height={842}
                        cellPadding={0}
                    ...
                    >
                        ...
                        <tr style={{height: 19}}>
                            <td/>
                            <td colSpan={19} style={{textIndent: 0, textAlign: "center"}}>
                  <span
                      style={{
                  ...
                  >
                    Local:
                            ...
                            <td
                                colSpan={18}
                                rowSpan={2}
                                style={{paddingTop: 3, textIndent: 0, textAlign: "left"}}
                            />
                            <td/>
                        </tr>
                        <tr style={{height: 19}}>
                  ...
                  >
                    Condutor
                        ...
                        <tr style={{height: 1}}>
                            <td/>
                            <td colSpan={19} style={{borderTop: "1px solid #000000"}}/>
                            <td/>
                        </tr>
                        <tr style={{height: 19}}>
                            <td/>
                  ...
                  >
                    Certifico que o documento referido neste Aviso
                    <br/>
                    foi apresentado em:
                    <br/>
                    <br/>
                  ...
                  >
                    ...
                    <br/>
                    (Nome, Número, posto e carimbo a óleo)
                  </span>
                            </td>
                            <td colSpan={2}/>
                        </tr>
