...
export default class Assinatura {
     ...
     * @param isreduzida
     */
    public cc_sign(posx: number, posy: number, idcord = 0, isreduzida = 1): Promise<ResponseSignature> {
     ...
     * @param isreduzida
     */
    public ceger_sign(posx: number, posy: number, idcord = 0, isreduzida = 1): Promise<ResponseSignature> {
        return new Promise((resolve, reject) => {
     ...
     * @param num
     */
    public cmd_sign(posx: number, posy: number, idcord = 0, isreduzida = 1, numeroTelefone:string ): Promise<ResponseSignature> {
        return new Promise((resolve, reject) => {
